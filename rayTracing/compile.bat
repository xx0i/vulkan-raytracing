...
C:/VulkanSDK/1.4.309.0/Bin/glslangValidator.exe -V --target-env vulkan1.2 quadClosesthit.rchit -o quadrchit.spv
C:/VulkanSDK/1.4.309.0/Bin/glslangValidator.exe -V --target-env vulkan1.2 sphereClosesthit.rchit -o sphererchit.spv
C:/VulkanSDK/1.4.309.0/Bin/glslangValidator.exe -V --target-env vulkan1.2 anyhit.rahit -o rahit.spv
C:/VulkanSDK/1.4.309.0/Bin/glslangValidator.exe -V --target-env vulkan1.2 transitionColour.comp -o comp.spv
